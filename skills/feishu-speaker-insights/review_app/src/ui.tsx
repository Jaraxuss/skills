    ...
    <div className="app-frame">
      <aside className="app-sidebar">
        ...
        <nav className="app-nav">
          ...
          <NavLink to="/enrollments" className={navClass}>
            <ListChecks size={17} />
            <span>声纹任务</span>
          </NavLink>
        ...
        <div className="sidebar-status">
          ...
          <span>本地 CPU 推理 · 数据不出机</span>
        </div>
      </aside>
      <div className="app-main">
        <header className="app-topbar">
          <span className="topbar-workspace">本地声纹工作区</span>
...
export function DashboardIcon({
  ...
  kind: "tasks" | "profiles" | "audio" | "database";
}) {
...
export function TaskStatusIcon({ status }: { status: string }) {
  ...
  if (status === "failed" || status === "source_changed")
