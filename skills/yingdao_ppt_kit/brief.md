...
Speaker notes are generated by default. Only set `enabled: false` when the user explicitly asks not to receive a talk track. Do not use NotebookLM unless the user explicitly asks for it.
...
| Slide | Role | Intent | Key Points | Layout Family | Visual Asset | Density | Note Role / Context | Transition Intent | Sources / Appendix |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | cover | [open the customer story] | [literal customer-facing title; customer context] | title + hero visual | [hero image / product screenshot / brand image] | low | [opening; background and audience concern] | [move from opening to why this matters] | [source reminder; main] |
| 2 | setup | [explain why this matters now] | [business tension; expected outcome] | statement or contrast | [business scene / process contrast] | low-medium | [explanation; customer-specific context] | [move from problem to route] | [sources; main] |
| 3 | map | [show route and modules] | [modules; business outcomes] | timeline / route map | [icons / step map] | medium | [decision; how to introduce the route] | [move to the first module] | [sources; main] |
| ... | ... | ... | ... | ... | ... | ... | ... | ... | ... |
...
- Every main slide has direct-readable speaker notes with a natural next-slide transition, unless the user explicitly opted out.
